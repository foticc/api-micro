...
let menus: Menu[] = [
  ...
  },
  {
    ...
    alIcon: '',
    icon: 'caret-down',
    path: '/default/page-demo/new-layout',
    code: 'default:page-demo:new-layout',
    orderNum: 9,
    status: true,
    newLinkFlag: false,
    visible: true
  ...
  },
  {
    ...
    alIcon: '',
    icon: 'border-horizontal',
    path: '/default/feat/keep-alive',
    code: 'default:feat:keep-alive',
    orderNum: 26,
    status: true,
    newLinkFlag: false,
    visible: true
  ...
  },
  {
    ...
    alIcon: '',
    icon: 'caret-down',
    path: '/default/comp/blingbling',
    code: 'default:comp:blingbling',
    orderNum: 8,
    status: true,
    newLinkFlag: false,
    visible: true
  ...
  },
  {
    ...
    alIcon: '',
    icon: 'book',
    path: '/default/system/dict',
    code: 'default:system:dict',
    orderNum: 5,
    status: true,
    newLinkFlag: false,
    visible: true
  ...
  },
  {
    ...
    code: 'default:feat:frame:other-link',
    orderNum: 2,
    status: true,
    newLinkFlag: true,
    visible: true
  ...
  { id: 134, fatherId: 131, menuName: '字典类型删除', menuType: 'F', alIcon: '', icon: '', path: '', code: 'default:system:dict:del', orderNum: 3, status: true, newLinkFlag: false, visible: false },
  {
    ...
    icon: '',
    path: '',
    code: 'default:system:dict:item:add',
    orderNum: 4,
    status: true,
    newLinkFlag: false,
    visible: false
  },
  {
    ...
    icon: '',
    path: '',
    code: 'default:system:dict:item:edit',
    orderNum: 5,
    status: true,
    newLinkFlag: false,
    visible: false
  },
  {
    ...
    icon: '',
    path: '',
    code: 'default:system:dict:item:del',
    orderNum: 6,
    status: true,
    newLinkFlag: false,
    visible: false
  ...
  },
  {
    ...
    alIcon: '',
    icon: 'logout',
    path: '/default/feat/transitions',
    code: 'default:feat:transitions',
    orderNum: 27,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'logout',
    path: '/default/comp/lazy/lazy-defer',
    code: 'default:comp:lazy:lazy-defer',
    orderNum: 3,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    id: 119,
    fatherId: 52,
    menuName: '懒加载script脚本',
    menuType: 'C',
    alIcon: '',
    icon: 'login',
    path: '/default/comp/lazy/lazy-loadscript',
    code: 'default:comp:lazy:lazy-loadscript',
    orderNum: 4,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'up-circle',
    path: '/default/comp/lazy/dynamic-comp',
    code: 'default:comp:lazy:dynamic-comp',
    orderNum: 5,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'slack-square',
    path: '/default/feat/signal-demo',
    code: 'default:feat:signal-demo',
    orderNum: 28,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'rollback',
    path: '/default/feat/signal-demo/basic-advanced',
    code: 'default:feat:signal-demo:basic-advanced',
    orderNum: 1,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    id: 123,
    fatherId: 121,
    menuName: 'linkedSignal演示',
    menuType: 'C',
    alIcon: '',
    icon: 'border-horizontal',
    path: '/default/feat/signal-demo/linked-signal-demo',
    code: 'default:feat:signal-demo:linked-signal-demo',
    orderNum: 2,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'alipay-circle',
    path: '/default/feat/signal-demo/performance-optimization',
    code: 'default:feat:signal-demo:performance-optimization',
    orderNum: 3,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'play-circle',
    path: '/default/feat/signal-demo/resource',
    code: 'default:feat:signal-demo:resource',
    orderNum: 4,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'up-circle',
    path: '/default/feat/signal-demo/cross-comp-communication',
    code: 'default:feat:signal-demo:cross-comp-communication',
    orderNum: 5,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    id: 127,
    fatherId: 121,
    menuName: '与Observable互转',
    menuType: 'C',
    alIcon: '',
    icon: 'border-inner',
    path: '/default/feat/signal-demo/change-to-observable',
    code: 'default:feat:signal-demo:change-to-observable',
    orderNum: 6,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    id: 128,
    fatherId: 121,
    menuName: 'Signal&Reactive Forms',
    menuType: 'C',
    alIcon: '',
    icon: 'caret-left',
    path: '/default/feat/signal-demo/signal-reactive-forms',
    code: 'default:feat:signal-demo:signal-reactive-forms',
    orderNum: 7,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'instagram',
    path: '/default/feat/signal-demo/signal-comprehensive-practical',
    code: 'default:feat:signal-demo:signal-comprehensive-practical',
    orderNum: 8,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'menu-fold',
    path: '/default/feat/multilingual',
    code: 'default:feat:multilingual',
    orderNum: 29,
    status: true,
    newLinkFlag: false,
    visible: true
