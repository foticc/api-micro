...
export default [
  ...
  {
    path: 'lazy-scroll',
    title: 'menu.default:comp:lazy:lazy-scroll',
    data: { key: 'lazy-scroll' },
    loadComponent: () => import('./lazy-scroll/lazy-scroll.component').then(m => m.LazyScrollComponent)
  },
  ...
  {
    path: 'lazy-loadscript',
    title: 'menu.default:comp:lazy:lazy-loadscript',
    data: { key: 'lazy-loadscript' },
    loadComponent: () => import('./lazy-loadscript/lazy-loadscript').then(m => m.LazyLoadscript)
  }
] satisfies Route[];
